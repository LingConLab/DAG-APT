...
На этой странице находятся лексемы, являющиеся источниками заимствований в дагестанские языки, встречающихся в базе данных. Вы можете обнаружить больше информации в базе данных. В колонка "Translation" содержится перевод, из оригинального источника. Английский и русский словарный переводы добавлены для сравнения.

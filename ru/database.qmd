...
На этой странице содержится база данных заимствованных слов в дагестанских языках. Для поиска в колонках с числами используйте "1...1" для конкретного значения. Вы также можете использовать "1...5" для поиска диапазона
